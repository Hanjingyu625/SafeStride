    ...
    try:
        while True:
            ...
            try:
                ...
                signal_direction = crosswalk["signal_direction"]
            ...
            if crosswalk is not None:
                ...
                print(
                    "Signal direction  :",
                    DIRECTION_NAMES.get(
                        crosswalk["signal_direction"],
                        "-",
                    ),
                    "(" + crosswalk["signal_direction"] + ")",
                )
                print(
                    "Signal bearing    : %.1f deg"
                    % crosswalk["signal_bearing_deg"]
                )
                print(
