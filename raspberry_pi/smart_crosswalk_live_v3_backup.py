        ...
        while True:
            ...
            try:
                ...
                if need_map_refresh:
                    ...
                    # Force a fresh signal request after the intersection changes.
                    signal_data_cache = None
                    signal_cache_time = 0.0
                ...
                if crosswalk["distance_m"] > MAX_CROSSWALK_DISTANCE_M:
                    ...
                    if (
                        ...
                        signal_raw_values = raw_signal_values(
                            signal_data_cache,
                            last_direction,
                        )
                        ...
                        try:
                            ...
                            if len(valid_values) == 1:
                                signal_s, signal_field = valid_values[0]
                                error_text = (
                                    "AUTO FIELD: "
                                    + signal_field
                                    + "; GPS direction did not match"
                                )

                            elif len(valid_values) > 1:
                                error_text = (
                                    "Multiple valid signal fields: "
                                    + str(valid_values)
                                )
            ...
            if signal_raw_values:
                print("Signal raw     :", signal_raw_values)
            else:
                print("Signal raw     : -")
